...
* __file_path__: Is the location of the file within the shared_folder. /.../SHARED_FOLDER/{file_path}
* __with_metadata__: If True, words timestamps and confidence will be computed and returned. If false, the fields will be empty.
